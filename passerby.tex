...
\end{enumerate}
 ...
 % TODO: Return to DHT architecture for discovery.
 % Find a way to maintain the DHT with less communication:
 % Possibly sending only relevant fingers, instead of sending all known fingers.
 % Should prove that this idea works.
